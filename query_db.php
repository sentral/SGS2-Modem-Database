...
resultToTable($result, array("firmware" => "Firmware", "kernel" => "Kernel", "modem" => "Modem / ICS only", "provider" => "Provider", "region" => "Region", "phone_quality" => "Telefon Q", "internet_quality" => "Internet Q", "avg_dBm" => "Avg. dBm", "avg_dBm_wifi" => "Avg. dBm WiFi", "timetested" => "Zeitraum"), array("phone_quality" => array($dbt_rating, "rating_id", array("rating")), "internet_quality" => array($dbt_rating, "rating_id", array("rating")), "provider" => array($dbt_provider, "provid", array("provider")), "firmware" => array($dbt_firmware, "fw_id", array("firmware")), "kernel" => array($dbt_kernel, "krnl_id", array("kernel")), "region" => array($dbt_region, "region_id", array("city", "postalcode", "area", "country")), "modem" => array($dbt_modem, "modem_id", array("modem", "ics_only"))));
